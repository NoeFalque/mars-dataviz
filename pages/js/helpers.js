...
function reloadDOM() {
	...
	if(TaskManager.openTasks() === 0) {
		$('#tasksTab').append('<p class="empty"><i class="glyphicon glyphicon-thumbs-up"></i>  No Tasks!</p>');
	}

	if(TaskManager.inArchive() === 0) {
		$('#archiveTab').append('<p class="empty"><i class="glyphicon glyphicon-thumbs-up"></i>  No Tasks Archived!</p>');
	}

	if(TaskManager.inTrash() === 0) {
		$('#trashTab').append('<p class="empty"><i class="glyphicon glyphicon-thumbs-up"></i> Empty!</p>');
	}
