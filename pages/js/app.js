...
var TaskManager = function() {
	...
	function buildTask(task) {
		...
		// set the innerHTML
		element.innerHTML = '<input type="text" data-ref="'+task.id+'" id="taskBox-title" value="'+task.title+'" placeholder="Your Title" maxlength="50"><textarea data-ref="'+task.id+'" name="taskBox-body" id="taskBox-body" placeholder="Content Here">'+task.body+'</textarea><div class="taskBox-footer"><p><i class="glyphicon glyphicon-time"></i>Created on : '+task.createdOn+'</p><div class="actions"><ul><li><a href="javascript:;" onclick="TaskManager.archive('+task.id+')"  class="btn" data-toggle="tooltip" data-placement="bottom" title="Archive"><i class="glyphicon glyphicon-check"></i></a></li><li><a href="javascript:;" onclick="TaskManager.delete('+task.id+')" class="btn" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="glyphicon glyphicon-trash"></i></a></li></ul></div></div>';
	...
	function buildArchive(task) {
		...
		element.innerHTML = '<input type="text" data-ref="'+task.id+'" id="taskBox-title" value="'+task.title+'" placeholder="Your Title" READONLY><textarea data-ref="'+task.id+'" name="taskBox-body" id="taskBox-body" placeholder="Content Here" READONLY>'+task.body+'</textarea><div class="taskBox-footer"><p><i class="glyphicon glyphicon-time"></i>Created on : '+task.createdOn+'</p><div class="actions"><ul><li><a href="javascript:;" onclick="TaskManager.restoreArchive('+task.id+')"  class="btn" data-toggle="tooltip" data-placement="bottom" title="Archive"><i class="glyphicon glyphicon-th-list"></i></a></li><li><a href="javascript:;" onclick="TaskManager.fromArchiveToTrash('+task.id+')" class="btn" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a></li></ul></div></div>';
		// append in the DOM
	...
	function buildTrash(task) {
		...
		element.innerHTML = '<input type="text" data-ref="'+task.id+'" id="taskBox-title" value="'+task.title+'" placeholder="Your Title" READONLY><textarea data-ref="'+task.id+'" name="taskBox-body" id="taskBox-body" placeholder="Content Here" READONLY>'+task.body+'</textarea><div class="taskBox-footer"><p><i class="glyphicon glyphicon-time"></i>Created on : '+task.createdOn+'</p><div class="actions"><ul><li><a href="javascript:;" onclick="TaskManager.restore('+task.id+')"  class="btn" data-toggle="tooltip" data-placement="bottom" title="Recover Task"><i class="glyphicon glyphicon-th-list"></i></a></li><li><a href="javascript:;" onclick="TaskManager.removeFromTrash('+task.id+')" class="btn" data-toggle="tooltip" data-placement="bottom" title="Remove from Trash"><i class="glyphicon glyphicon-remove-circle"></i></a></li></ul></div></div>';
	...
	return {
		...
		add: function() {
			...
			var createdOn = curr_month + '/' + curr_date + '/' + curr_year;
